...
mecanicos = Blueprint("mecanicos", __name__)
...
@mecanicos.route("/cadastrar", methods = ['GET', 'POST'])
...
@mecanicos.route("/editar/<int:id>", methods = ['GET', 'POST'])
...
@mecanicos.route("/deletar/<int:id>")
