...
@estoque.route("/cadastrar_categoria", methods = ['GET', 'POST'])
...
@estoque.route("/cadastrar_subcategoria", methods = ['GET', 'POST'])
...
@estoque.route("/cadastrar_peca", methods = ['GET', 'POST'])
def CadastrarPeca():
    if request.method == 'GET':
        try:
            conexao = db.ConectarBanco()
...
@estoque.route("/editar_peca/<int:id>/<int:id_subcategoria>", methods = ['GET', 'POST'])
...
@estoque.route("/deletar_peca/<int:id>")
def DeletarPeca(id):
    try:
        conexao = db.ConectarBanco()
        cursor = conexao.cursor()
